...
func main() {
	...
	oneAcoountStake(10) // use the 10th account to deposit and become validator 
	...
	//TNT20
	mainchainTNT20Lock(big.NewInt(10))// last address printed in console is subchain voucher contract address
	...
	//TNT721
	mainchainTNT721Lock(big.NewInt(10))  //last address printed in console is subchain voucher contract address
