...
func NewServicePaymentTxExecutor(state *slst.LedgerState) *ServicePaymentTxExecutor {
	return &ServicePaymentTxExecutor{
		state: state,
	}
}

func (exec *ServicePaymentTxExecutor) sanityCheck(chainID string, view *slst.StoreView, transaction types.Tx) result.Result {
...
func (exec *ServicePaymentTxExecutor) process(chainID string, view *slst.StoreView, transaction types.Tx) (common.Hash, result.Result) {
	tx := transaction.(*types.ServicePaymentTx)
...
func (exec *ServicePaymentTxExecutor) splitPayment(view *slst.StoreView, splitRule *types.SplitRule, resourceID string,
...
func (exec *ServicePaymentTxExecutor) getTxInfo(transaction types.Tx) *score.TxInfo {
	tx := transaction.(*types.ServicePaymentTx)
	return &score.TxInfo{
