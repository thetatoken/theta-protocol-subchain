...
import (
	...
	sldvm "github.com/thetatoken/thetasubchain/ledger/vm"
)
...
func (t *ThetaRPCService) CallSmartContract(args *CallSmartContractArgs, result *CallSmartContractResult) (err error) {
	var ledgerState *sldst.StoreView
	...
	vmRet, contractAddr, gasUsed, vmErr := sldvm.Execute(parentBlock, sctx, ledgerState)
	ledgerState.Save()
