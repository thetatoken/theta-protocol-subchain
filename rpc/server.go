...
func NewThetaRPCServer(mempool *smp.Mempool, ledger *sld.Ledger, dispatcher *dispatcher.Dispatcher,
	...
	t.router.Handle("/debug/pprof/", http.Handler(http.DefaultServeMux))
