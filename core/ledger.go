...
type Ledger interface {
	...
	ProposeBlockTxs(block *Block, shouldIncludeValidatorUpdateTxs bool, includeInterChainMessageTxsTillNonce *big.Int) (stateRootHash common.Hash, blockRawTxs []common.Bytes, res result.Result)
