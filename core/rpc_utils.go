...
var EventSelectors = map[InterChainMessageEventType]string{
	// TokenLock events
	IMCEventTypeCrossChainTokenLockTFuel: crypto.Keccak256Hash([]byte("TFuelTokenLocked(string,address,uint256,address,uint256,uint256)")).Hex(),
	IMCEventTypeCrossChainTokenLockTNT20: crypto.Keccak256Hash([]byte("TNT20TokenLocked(string,address,uint256,address,uint256,string,string,uint8,uint256)")).Hex(),
	...
	// TokenUnlock events
	IMCEventTypeCrossChainTokenUnlockTFuel: crypto.Keccak256Hash([]byte("TFuelTokenUnlocked(string,address,uint256,uint256,uint256)")).Hex(),
	IMCEventTypeCrossChainTokenUnlockTNT20: crypto.Keccak256Hash([]byte("TNT20TokenUnlocked(string,address,uint256,uint256,uint256)")).Hex(),
	...
	// VoucherBurn events
	IMCEventTypeCrossChainVoucherBurnTFuel: crypto.Keccak256Hash([]byte("TFuelVoucherBurned(string,address,address,uint256,uint256)")).Hex(),
	IMCEventTypeCrossChainVoucherBurnTNT20: crypto.Keccak256Hash([]byte("TNT20VoucherBurned(string,address,address,uint256,uint256)")).Hex(),
...
func extractTFuelVoucherBurnedEvent(sourceChainID *big.Int, logData LogData, events *[]*InterChainMessageEvent) {
	...
	blockHeight, _ := new(big.Int).SetString(logData.BlockNumber[2:], 16)
	originatedChainID, err := ExtractOriginatedChainIDFromDenom(tma.Denom)
	if err != nil {
