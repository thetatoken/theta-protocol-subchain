...
var TokenBankMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"mainchainID_\",\"type\":\"uint256\"},{\"internalType\":\"contractChainRegistrar\",\"name\":\"chainRegistrar_\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"a\",\"type\":\"uint256\"}],\"name\":\"ta\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address[]\",\"name\":\"validators\",\"type\":\"address[]\"},{\"indexed\":false,\"internalType\":\"uint256[]\",\"name\":\"shareAmounts\",\"type\":\"uint256[]\"}],\"name\":\"va\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"mainchainID\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"tokenLockNonceMap\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"},{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"name\":\"tokenLockVotingRecords\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"dynasty\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"accumlatedShares\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"tokenUnlockNonceMap\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"voucherBurnNonceMap\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"},{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"name\":\"voucherBurnVotingRecords\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"dynasty\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"accumlatedShares\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"voucherMintNonceMap\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"chainID\",\"type\":\"uint256\"}],\"name\":\"getMaxProcessedTokenLockNonce\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"chainID\",\"type\":\"uint256\"}],\"name\":\"getMaxProcessedVoucherBurnNonce\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
	Bin: "",
}
...
// TokenBankTaIterator is returned from FilterTa and is used to iterate over the raw logs and unpacked data for Ta events raised by the TokenBank contract.
type TokenBankTaIterator struct {
	Event *TokenBankTa // Event containing the contract specifics and raw log
...
func (it *TokenBankTaIterator) Next() bool {
...
func (it *TokenBankTaIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenBankTaIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenBankTa represents a Ta event raised by the TokenBank contract.
type TokenBankTa struct {
	A   *big.Int
...
func (_TokenBank *TokenBankFilterer) FilterTa(opts *bind.FilterOpts) (*TokenBankTaIterator, error) {

	logs, sub, err := _TokenBank.contract.FilterLogs(opts, "ta")
	if err != nil {
		return nil, err
	}
	return &TokenBankTaIterator{contract: _TokenBank.contract, event: "ta", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ta(uint256 a)
func (_TokenBank *TokenBankFilterer) WatchTa(opts *bind.WatchOpts, sink chan<- *TokenBankTa) (event.Subscription, error) {

	logs, sub, err := _TokenBank.contract.WatchLogs(opts, "ta")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenBankTa)
				if err := _TokenBank.contract.UnpackLog(event, "ta", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ta(uint256 a)
func (_TokenBank *TokenBankFilterer) ParseTa(log types.Log) (*TokenBankTa, error) {
	event := new(TokenBankTa)
	if err := _TokenBank.contract.UnpackLog(event, "ta", log); err != nil {
		return nil, err
	}
...
// TokenBankVaIterator is returned from FilterVa and is used to iterate over the raw logs and unpacked data for Va events raised by the TokenBank contract.
type TokenBankVaIterator struct {
	Event *TokenBankVa // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenBankVaIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenBankVaIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenBankVaIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenBankVa represents a Va event raised by the TokenBank contract.
type TokenBankVa struct {
...
func (_TokenBank *TokenBankFilterer) FilterVa(opts *bind.FilterOpts) (*TokenBankVaIterator, error) {

	logs, sub, err := _TokenBank.contract.FilterLogs(opts, "va")
	if err != nil {
		return nil, err
	}
	return &TokenBankVaIterator{contract: _TokenBank.contract, event: "va", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event va(address[] validators, uint256[] shareAmounts)
func (_TokenBank *TokenBankFilterer) WatchVa(opts *bind.WatchOpts, sink chan<- *TokenBankVa) (event.Subscription, error) {

	logs, sub, err := _TokenBank.contract.WatchLogs(opts, "va")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenBankVa)
				if err := _TokenBank.contract.UnpackLog(event, "va", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event va(address[] validators, uint256[] shareAmounts)
func (_TokenBank *TokenBankFilterer) ParseVa(log types.Log) (*TokenBankVa, error) {
	event := new(TokenBankVa)
	if err := _TokenBank.contract.UnpackLog(event, "va", log); err != nil {
		return nil, err
	}
