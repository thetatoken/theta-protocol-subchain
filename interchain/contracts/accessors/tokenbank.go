...
var TokenBankMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func (_TokenBank *TokenBankCaller) SubchainID(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TokenBank.contract.Call(opts, &out, "subchainID")
...
//
// Solidity: function subchainID() view returns(uint256)
func (_TokenBank *TokenBankSession) SubchainID() (*big.Int, error) {
	return _TokenBank.Contract.SubchainID(&_TokenBank.CallOpts)
}

// SubchainID is a free data retrieval call binding the contract method 0xf8e8f7aa.
//
// Solidity: function subchainID() view returns(uint256)
func (_TokenBank *TokenBankCallerSession) SubchainID() (*big.Int, error) {
	return _TokenBank.Contract.SubchainID(&_TokenBank.CallOpts)
}
